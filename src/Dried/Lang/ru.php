...
return [
    ...
    'calendar' => [
        ...
        'nextDay' => '[Завтра, в] LT',
        'nextWeek' => static function (DateTimeInterface $current, DateTimeInterface $other) {
            if ($current->format('o-W') !== $other->format('o-W')) {
                switch ((int) $current->format('w')) {
                    case 0:
        ...
        'lastDay' => '[Вчера, в] LT',
        'lastWeek' => static function (DateTimeInterface $current, DateTimeInterface $other) {
            if ($current->format('o-W') !== $other->format('o-W')) {
                switch ((int) $current->format('w')) {
                    case 0:
