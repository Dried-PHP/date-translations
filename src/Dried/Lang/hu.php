...
return [
    ...
    'calendar' => [
        ...
        'nextWeek' => static function (DateTimeInterface $date) use ($huWeekEndings) {
            return '['.$huWeekEndings[(int) $date->format('w')].'] LT[-kor]';
        },
        'lastDay' => '[tegnap] LT[-kor]',
        'lastWeek' => static function (DateTimeInterface $date) use ($huWeekEndings) {
            return '[múlt '.$huWeekEndings[(int) $date->format('w')].'] LT[-kor]';
        },
        'sameElse' => 'L',
    ],
    'meridiem' => ['DE', 'DU'],
