...
return [
    ...
    'calendar' => [
        'sameDay' => static fn (DateTimeInterface $current) => '[avui a ' . (((int) $current->format('G')) !== 1 ? 'les' : 'la').'] LT',
        'nextDay' => static fn (DateTimeInterface $current) => '[demà a ' . (((int) $current->format('G')) !== 1 ? 'les' : 'la').'] LT',
        'nextWeek' => static fn (DateTimeInterface $current) => 'dddd [a ' . (((int) $current->format('G')) !== 1 ? 'les' : 'la').'] LT',
        'lastDay' => static fn (DateTimeInterface $current) => '[ahir a '.(((int) $current->format('G')) !== 1 ? 'les' : 'la').'] LT',
        'lastWeek' => static fn (DateTimeInterface $current) => '[el] dddd [passat a '.(((int) $current->format('G')) !== 1 ? 'les' : 'la').'] LT',
        'sameElse' => 'L',
    ],
