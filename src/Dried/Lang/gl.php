...
return [
    ...
    'calendar' => [
        'sameDay' => static fn (DateTimeInterface $current) => '[hoxe ' . (((int) $current->format('G')) !== 1 ? 'ás' : 'á') . '] LT',
        'nextDay' => static fn (DateTimeInterface $current) => '[mañá ' . (((int) $current->format('G')) !== 1 ? 'ás' : 'á') . '] LT',
        'nextWeek' => static fn (DateTimeInterface $current) => 'dddd [' . (((int) $current->format('G')) !== 1 ? 'ás' : 'á') . '] LT',
        'lastDay' => static fn (DateTimeInterface $current) => '[onte ' . (((int) $current->format('G')) !== 1 ? 'á' : 'a') . '] LT',
        'lastWeek' => static fn (DateTimeInterface $current) => '[o] dddd [pasado ' . (((int) $current->format('G')) !== 1 ? 'ás' : 'á') . '] LT',
        'sameElse' => 'L',
    ],
    'ordinal' => ':numberº',
